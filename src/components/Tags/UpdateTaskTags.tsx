...
import { addTag, removeTag as removeT, addAllTags } from '@/features/Tags/tagSlice';

interface UpdateTaskTagsProps {
    selectedTags: string[]
}

const UpdateTaskTags: React.FC<UpdateTaskTagsProps> = ({ selectedTags }) => {
    ...
    useEffect(() => {
        ...
        dispatch(addAllTags(selectedTags));
    }, [selectedTags]);
